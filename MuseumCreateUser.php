<?php
    require "db.php";
    $museumid = $_GET['id'];
    $museum = R::findOne('museums', 'id = ?', array($museumid));
    ...
    <div class="wrapper">
        <div class="content">
            <section class="Section-Panels">
                ...
                <form action="/process_comment.php" method="post" class="Form_Comentaries" id="Form_Comentaries">
                    <textarea name="textComment" id="textComment" class="textComment" placeholder="Напишіть коментар"></textarea>
                    ...
                    <div class="comments_container">
                        ...
                        <?php 
                            $comment = R::findAll('comentaries');
                            foreach($comment as $comentaries):
                        ?>
                            <div class="comments_user">
                                <div class="image_author_comment">
                                    <img class="author_comment_image" src="upload/avatars/<?= $comentaries->EmojiImage;?>" alt="">
                                </div>
                                <div class="author_and_comment">
                                    <div class="author_comment">
                                        <p><?= $comentaries->authorComent ?></p>
                                    </div>
                                    <div class="comment_museum">
                                        <p><?= $comentaries->textComment ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
